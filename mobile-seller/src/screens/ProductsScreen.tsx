...
export default function ProductsScreen() {
  ...
  const del = () => Alert.alert('Delete','Are you sure you want to delete this product?',[
      ...
      <FlatList data={products} keyExtractor={p=>p.id}
        ...
        ListEmptyComponent={
          <View style={s.empty}>
            ...
            <Text style={{fontSize:13,color:GRAY,textAlign:'center'}}>Add your first product to start selling on ShopNekt</Text>
          </View>
        }
        renderItem={({item:p})=>(
...
const s = StyleSheet.create({
  ...
  img:     { height:100,backgroundColor:OFF,alignItems:'center',justifyContent:'center' },
  pName:   { fontSize:13,fontWeight:'700',color:NAVY,padding:8,paddingBottom:2 },
  pPrice:  { fontSize:12,fontWeight:'800',color:GREEN,paddingHorizontal:8,paddingBottom:8 },

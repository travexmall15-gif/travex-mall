        ...
        {step === 'confirm' && (
          <>
            ...
            <button onClick={submitPayment} disabled={submitting}
              style={{ width:'100%', padding:'0.9rem', background:'#fff', color:'#1D4ED8', border:'none', borderRadius:14, fontWeight:700, fontSize:'0.9rem', cursor: submitting?'not-allowed':'pointer', fontFamily:"'Inter',sans-serif", display:'flex', alignItems:'center', justifyContent:'center', gap:8 }}>
              {submitting
        ...
        {step === 'done' && (
          <div style={{ textAlign:'center', padding:'2rem 0' }}>
            ...
            <button onClick={() => router.push('/orders')}
              style={{ padding:'12px 32px', background:'#fff', color:'#1D4ED8', border:'none', borderRadius:14, fontWeight:700, fontSize:'0.9rem', cursor:'pointer', fontFamily:"'Inter',sans-serif" }}>
              View My Orders
            </button>
          </div>
        )}

  ...
  return (
    <div style={{ position:'fixed',inset:0,background:'#080F37',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',transition:'opacity 0.6s ease',opacity:fade?0:1 }}>
      <style>{`
         ...
         to{width:clamp(80px,12vw,120px);opacity:1} }
      ...
      <p style={{ fontFamily:"'Inter',sans-serif", fontSize:'clamp(0.48rem,1.1vw,0.65rem)', color:'rgba(255,255,255,0.32)', letterSpacing:'0.22em', textTransform:'uppercase', margin:'0', }}>
        shop more. save more. live better.
      </p>
      <p style={{ fontFamily:"'Inter',sans-serif", fontSize:'clamp(0.45rem,0.9vw,0.58rem)', color:'rgba(255,255,255,0.18)', letterSpacing:'0.20em', textTransform:'uppercase', marginTop:'8px', }}>
        from qnex360
      </p>
    </div>
  )

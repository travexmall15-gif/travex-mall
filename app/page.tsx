  ...
  return (
    <div style={{ position:'fixed',inset:0,background:'#080F37',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',transition:'opacity 0.6s ease',opacity:fade?0:1 }}>
      <style>{`
        ...
        .sp-letter { display:inline-block;font-family:'Inter',sans-serif;font-size:clamp(1.8rem,5.5vw,4rem);font-weight:800;letter-spacing:-0.03em;color:#fff;letter-spacing:0.12em;opacity:0;animation:letterDrop 0.45s cubic-bezier(0.34,1.56,0.64,1) forwards }

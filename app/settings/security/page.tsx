      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '1.5rem 5% 4rem' }}>
        ...
        <div style={{ background: 'var(--sn-bg)', borderRadius: 16, border: '1.5px solid #E2E8F0', padding: '1.25rem', marginBottom: '1rem' }}>
          ...
          <button onClick={changePassword} disabled={loading}
            style={{ width: '100%', marginTop: '1rem', padding: '0.8rem', background: 'var(--sn-bg)', color: 'var(--sn-text)', border: 'none', borderRadius: 12, fontFamily: 'var(--sn-font)', fontWeight: 700, fontSize: '0.875rem', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>

    ...
    <main style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#f8f9fc', minHeight: '100vh', color: '#0D1B3E' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0D1B3E 0%, #1B3A8A 100%)', padding: 'clamp(3rem,8vw,5rem) 1.5rem', textAlign: 'center', color: '#fff' }}>
        ...
        <h1 style={{ fontFamily: "'Inter',sans-serif", fontSize: 'clamp(2rem, 6vw, 3.5rem)', fontWeight: 900, lineHeight: 1.1, marginBottom: '1rem', maxWidth: 700, margin: '0 auto 1rem' }}>
          ...
          <span style={{ color: '#C9A84C' }}>ShopNekt</span>
        </h1>
      ...
      <section style={{ padding: 'clamp(3rem,6vw,4rem) 1.5rem', maxWidth: 900, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <div style={{ fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.12em', color: '#C9A84C', marginBottom: 8 }}>{t('join.processLabel')}</div>
      ...
      <section style={{ padding: 'clamp(3rem,6vw,4rem) 1.5rem', background: '#0D1B3E' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            <div style={{ fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.12em', color: '#C9A84C', marginBottom: 8 }}>{t('join.marketsLabel')}</div>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: 20, padding: '2rem', border: '1px solid rgba(201,168,76,0.3)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1.5rem' }}>
                ...
                <div style={{ background: 'linear-gradient(135deg, rgba(201,168,76,0.15), rgba(201,168,76,0.08))', borderRadius: 12, padding: '1rem 1.25rem', border: '1px solid rgba(201,168,76,0.4)', position: 'relative' }}>
                  <div style={{ position: 'absolute', top: -10, right: 16, background: '#C9A84C', color: '#0D1B3E', fontSize: '0.6rem', fontWeight: 900, padding: '3px 10px', borderRadius: 999 }}>{t('join.mostPopular')}</div>
                  <div style={{ fontWeight: 800, color: '#C9A84C', marginBottom: 4 }}>{t('join.premiumPlanLabel')}</div>

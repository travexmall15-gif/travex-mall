...
export function InstallButtons() {
  return (
    <div style={{ display:'flex',gap:'12px',flexWrap:'wrap',justifyContent:'center',alignItems:'center' }}>
      ...
      <button onClick={() => alert('To install on iPhone/iOS:\n\n1. Open travex-mall.vercel.app in Safari\n2. Tap Share (□↑) at the bottom\n3. Tap "Add to Home Screen"\n4. Tap Add — Done! ✅')} style={{ display:'inline-flex',alignItems:'center',gap:'10px',background:'#0D1B3E',color:'#fff',border:'none',borderRadius:'14px',padding:'13px 22px',cursor:'pointer',fontFamily:'inherit',boxShadow:'0 4px 14px rgba(13,27,62,0.25)',minWidth:'165px' }}>

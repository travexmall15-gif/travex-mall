...
export function InstallButtons() {
  return (
    <div style={{ display:'flex',gap:'12px',flexWrap:'wrap',justifyContent:'center',alignItems:'center' }}>
      <a href="/ShopNekt.apk" download="ShopNekt.apk" style={{ display:'inline-flex',alignItems:'center',gap:'10px',background:'#fff',color:'#111827',border:'none',borderRadius:'14px',padding:'13px 22px',textDecoration:'none',fontFamily:'inherit',boxShadow:'0 4px 14px rgba(13,27,62,0.25)',minWidth:'165px' }}>
        ...
        <div style={{ textAlign:'left' }}>
          <div style={{ fontSize:'9px',color:'#6B7280',lineHeight:1,marginBottom:'2px' }}>DIRECT DOWNLOAD</div>
          <div style={{ fontSize:'15px',fontWeight:700,lineHeight:1 }}>Android APK</div>
        </div>
      </a>
      <button onClick={() => alert('To install on iPhone/iOS:\n\n1. Open travex-mall.vercel.app in Safari\n2. Tap Share (□↑) at the bottom\n3. Tap "Add to Home Screen"\n4. Tap Add, Done! ✅')} style={{ display:'inline-flex',alignItems:'center',gap:'10px',background:'#fff',color:'#111827',border:'none',borderRadius:'14px',padding:'13px 22px',cursor:'pointer',fontFamily:'inherit',boxShadow:'0 4px 14px rgba(13,27,62,0.25)',minWidth:'165px' }}>
        ...
        <div style={{ textAlign:'left' }}>
          <div style={{ fontSize:'9px',color:'#6B7280',lineHeight:1,marginBottom:'2px' }}>INSTALL ON</div>
